    ...
    return (
        <section className={styles.secaoBriefing}>
            ...
            <div className={styles.linhaBriefing}>
                ...
                <iframe width="700" height="2200" src="https://gestaodeprojetos.builderseunegocioonline.com.br/forms/wtl/0921b98983eeba22353238acda32eac4" frameborder="0" sandbox="allow-top-navigation allow-scripts allow-forms allow-same-origin" allowfullscreen></iframe>
