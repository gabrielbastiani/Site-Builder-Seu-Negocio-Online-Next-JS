...
import { SectionPrincipalPoliticas } from "../../components/componentsPoliticas/SectionPrincipalPoliticas";
...
export default function PoliticasDePrivacidade() {
    return (
        <>
            <Head>
                <title>Politicas de Privacidade - Builder Seu Negócio Online</title>
            </Head>

            <MenuTop />

            <SectionPrincipalPoliticas />
            ...
            <main>
                ...
                <section className={styles.sectionContainer}>
                    ...
                    <p>A sua privacidade &eacute; importante para n&oacute;s. &Eacute; pol&iacute;tica do Builder Seu Negocio Online respeitar a sua privacidade em rela&ccedil;&atilde;o a qualquer informa&ccedil;&atilde;o sua que possamos coletar no site <Link className={styles.link} href="https://builderseunegocioonline.com.br">Builder Seu Negocio Online</Link>, e outros sites que possu&iacute;mos e operamos.</p>
                    ...
                    <p>O nosso site pode ter links para sites externos que n&atilde;o s&atilde;o operados por n&oacute;s. Esteja ciente de que n&atilde;o temos controle sobre o conte&uacute;do e pr&aacute;ticas desses sites e n&atilde;o podemos aceitar responsabilidade por suas respectivas&nbsp;<Link className={styles.link} href="https://politicaprivacidade.com/" >pol&iacute;ticas de privacidade</Link>.</p>
                    ...
                    <p>O uso continuado de nosso site ser&aacute; considerado como aceita&ccedil;&atilde;o de nossas pr&aacute;ticas em torno de <Link className={styles.link} href='https://avisodeprivacidad.info/' rel='nofollow'>Aviso de Privacidade</Link> e informa&ccedil;&otilde;es pessoais. Se voc&ecirc; tiver alguma d&uacute;vida sobre como lidamos com dados do usu&aacute;rio e informa&ccedil;&otilde;es pessoais, entre em contacto connosco.</p>

                    <h2>Pol&iacute;tica de Cookies Builder Seu Negocio Online</h2>
                    ...
                    <p>O usu&aacute;rio se compromete a fazer uso adequado dos conte&uacute;dos e da informa&ccedil;&atilde;o que o Builder Seu Negocio Online oferece no site e com car&aacute;ter enunciativo, mas n&atilde;o limitativo:</p>
                    ...
                    <ul>
                        ...
                        <li>C) N&atilde;o causar danos aos sistemas f&iacute;sicos (hardwares) e l&oacute;gicos (softwares) do Builder Seu Negocio Online, de seus fornecedores ou terceiros, para introduzir ou disseminar v&iacute;rus inform&aacute;ticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                    </ul>
                    ...
                    <p>Esta pol&iacute;tica &eacute; efetiva a partir de <strong>10 setembro 2022 12:05</strong></p>
